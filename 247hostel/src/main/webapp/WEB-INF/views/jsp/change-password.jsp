                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form_wrapper">
                                    ...
                                    <form class="form-inner register-form " action="changePassword" method="POST">
                                        <div class="form-group">                                        
                                            <label for="Pasword" class="control-label">Nhập mật khẩu cũ</label>
                                            <input class="form-control" data-val="true" data-val-required="*" id="Password" name="passwordOld" required="required" type="password" value="" placeholder="Nhập mật khẩu cũ">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="form-group">                                        
                                            <label for="Pasword1" class="control-label">Nhập mật khẩu mới</label>
                                            <input class="form-control" data-val="true" data-val-required="*" id="Password1" name="passwordNew" required="required" type="password" value="" placeholder="Nhập mật khẩu mới">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="form-group">                                        
                                            <label for="Pasword2" class="control-label">Xác nhận mật khẩu mới</label>
                                            <input class="form-control" data-val="true" data-val-required="*" id="Password2" name="passwordNewConfirm" required="required" type="password" value="" placeholder="Xác nhận mật khẩu mới">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="btn_wrapper">
                                            <button type="submit" class="btn btn-success btn-block"><i class="fa fa-sign-in"></i> Đổi mật khẩu</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
