...
<head>
    ...
    <script>
        function getUsers(page) {
        	...
        	$.ajax({
        		type : "GET",
        		url : "http://localhost:8080/247hostel/api/getUsers",
        		data : {
        			page : page
        		},
                        ...
                        <div class="col-xs-12">
                            ...
                            <div>
                                <ul class="pagination">
                                    ...
                                    <li class="active">
                                        <a onclick="getUsers(1)">1</a>
                                    </li>

                                    <li>
                                        <a onclick="getUsers(2)">2</a>
                                    </li>

                                    <li>
                                        <a onclick="getUsers(3)">3</a>
                                    </li>

                                    <li>
                                        <a onclick="getUsers(4)">4</a>
                                    </li>

                                    <li>
                                        <a onclick="getUsers(5)">5</a>
                                    </li>
