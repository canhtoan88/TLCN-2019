            ...
            <div class="access_page">
                <div class="container">
                    ...
                    <div class="page_header">
                        <h1 class="page_title">Đổi email</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form_wrapper">
                                    ...
                                    <form class="form-inner register-form " action="changeEmail" method="POST">
                                        <div class="form-group">                                        
                                            <label for="Email" class="control-label">Nhập email mới</label>
                                            <input class="form-control" data-val="true" data-val-required="*" id="Email" name="email" required="required" type="text" value="" placeholder="Nhập email mới">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="btn_wrapper">
                                            <button type="submit" class="btn btn-success btn-block"><i class="fa fa-sign-in"></i> Đổi email</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
